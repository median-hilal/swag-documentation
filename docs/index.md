...
* [Homogeneous Independent Set Comparison Expression - Listing 8.5](chapter 8/homogeneousSetComp Pattern - with spaces.txt)
* [SPARQL Query - Listing 8.7](chapter 8/SPARQL query.txt)

# Chapter 9: Superimposed Enriched MD Model
* [Data Set - Table 9.4](chapter 9/dataset.ttl)
* [Mapping Queries - Table 9.3](chapter 9/mapping queries.txt)
* [Mapping Queries with Labels - Table 9.3](chapter 9/mapping queries with labels.txt)
* [Grouping and Aggregation Queries](chapter 9/grouping and aggregation queries.txt)
